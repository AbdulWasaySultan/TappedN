...
// import BackButton from '../../Components/Global/BackButton/BackButton';
// import { yogaSubCategories } from '../../utils/constants/serviceCategoryData';

// const { width, height } = Dimensions.get('window');

// export default function Yoga() {
//   const route = useRoute<RouteProp<RootStackParamList, 'Yoga'>>();
//   const navigation = useNavigation<NavigationProp<RootStackParamList>>();
//   const [searchServices, setSearchServices] = useState<string>('');
//   const [filteredService, setFilteredService] = useState(yogaSubCategories);
...
//     if (text.trim() === '') {
//       setFilteredService(yogaSubCategories);
//     } else {
//       const filtered = yogaSubCategories.filter(service =>
...
//         <Text style={styles.topContainerText}>Yoga</Text>
//       </View>
//       <View style={styles.searchView}>
//         <TextInput
//           placeholder="Search in Yoga"
