    ...
    >
      ...
      <View style={styles.rowContainer}>
        ...
        <View style={styles.itemScheduleContainer}>
          <Text style={[styles.itemPriceTextBold, { color: getColorForPrice(item.status) }]}>
            ${item.price}<Text style={{ fontSize: FontType.medium, color: '#42526E80' }}>/hr</Text>
          </Text>
          <Text style={[styles.itemSchedule, { color: getColorForStatus(item.status) }]}>
            {item.date}
          </Text>
        </View>
      </View>
